...
//                 ageStat.label = this.translate.instant(
//                     'STATISTICS.AGE_UNKNOWN'
//                 );
//             }
//             keys.push(ageStat.label);
//         }
//         const x = d3.scaleBand().range([0, width]).domain(keys).padding(0.2);
...
//             .attr('y', (d) => height)
//             .attr('x', (d) => x(d.label) as any) as any;
...
//             if (d?.label !== 'Nieznany') {
//                 let msg = '<table>';
//                 msg += `<th><br/>${this.translate.instant(
//                     'STATISTICS.AGE'
//                 )}</th><th>${this.translate.instant(
...
//             } else {
//                 let msg = '';
//                 msg += `<strong>${this.translate.instant(
//                     'STATISTICS.CHARS_NUM'
//                 )}:</strong> ${d?.count}`;
//                 tooltip.html(msg);
//             }
